...
<div class="max-w-3xl mx-auto">
    <div class="mb-6">
        <h2 class="text-2xl font-bold">Create Message Template</h2>
    ...
    <div class="card bg-base-100 shadow">
        <div class="card-body">
            <form method="POST" action="<?= url('messages/template/create') ?>">
                ...
                <div class="form-control mb-4">
                    ...
                    <select name="template_type" class="select select-bordered" required>
                        <option value="welcome" <?= selected(old('template_type'), 'welcome') ?>>Welcome</option>
                        <option value="followup" <?= selected(old('template_type'), 'followup') ?>>Follow-up</option>
                        <option value="nurture" <?= selected(old('template_type'), 'nurture') ?>>Nurture</option>
                        <option value="reminder" <?= selected(old('template_type'), 'reminder') ?>>Reminder</option>
                        <option value="other" <?= selected(old('template_type'), 'other') ?>>Other</option>
                    </select>
                </div>
                ...
                <div class="form-control mb-4">
                    ...
                    <textarea name="template_content" class="textarea textarea-bordered h-32" 
                              required><?= old('template_content') ?></textarea>
                </div>
